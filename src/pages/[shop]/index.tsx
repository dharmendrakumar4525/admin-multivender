				...
				<div className="flex flex-col p-6 2xl:p-7">
					...
					<div className="flex flex-col space-y-3">
						...
						<p className="text-sm text-sub-heading">
							...
							{document?.original ? (
								<Link href={document?.original} passHref>
									<a className="font-semibold flex items-center space-x-2 hover:underline" target='_blank'>
						...
						<p className="text-sm text-sub-heading">
							...
							{video?.original ? (
								<Link href={video?.original} passHref >
									<a className="font-semibold flex items-center space-x-2 hover:underline" target='_blank'>
										<BsDownload /> <span>Download</span>
									</a>
								</Link>
